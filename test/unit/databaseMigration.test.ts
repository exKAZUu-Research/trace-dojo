...
test('upgrades existing learning activity without losing timestamps, answers, or generated IDs', async () => {
  ...
  try {
    ...
    sqlite.exec(`
      INSERT INTO User VALUES ('student', '2026-09-01 00:00:00', 1788220800123, 'Student');
      ...
      VALUES (42, 1788220800123, 1788220800123, 'student', 'course', 'lecture', 'test1', '1', 'fillInBlank', 0, 250, 1788220800456);
      ...
      VALUES (12, 1788220800456, 42, 'fillInBlank', 0, 250, 1, '["answer"]', 2);
    `);
      ...
      problemSessions: [
        {
          ...
          submissions: [
            { id: 12, createdAt: new Date(1_788_220_800_456), isCorrect: true, answers: '["answer"]', gradingStage: 2 },
          ],
        },
      ],
    });
